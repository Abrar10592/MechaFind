  ...
  Future<void> _rejectJob(String requestId) async {
    final bool? confirmed = await showDialog<bool>(
      ...
      builder: (context) => AlertDialog(
        ...
        content: Text(
          'Are you sure you want to reject this job? This will make it available for other mechanics.',
          style: AppTextStyles.body,
        ),
        actions: [
          TextButton(
              ...
              : pendingJobs.isEmpty
                  ? Center(
                      child: Column(
                        ...
                        children: [
                          ...
                          Text(
                            isEnglish ? 'Accepted jobs will appear here' : 'গৃহীত কাজ এখানে দেখানো হবে',
                  ...
                  : ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        ...
                        return _buildPendingJobCard(job, isEnglish);
                      },
                    ),
        ),
      ),
